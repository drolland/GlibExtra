...
${TESTDIR}/tests/gx_test_csv_file.o: tests/gx_test_csv_file.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -std=c11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/gx_test_csv_file.o tests/gx_test_csv_file.c


${TESTDIR}/tests/gx_test_msort.o: tests/gx_test_msort.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -std=c11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/gx_test_msort.o tests/gx_test_msort.c
